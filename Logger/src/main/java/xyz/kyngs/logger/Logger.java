...
public interface Logger {
    ...
    default void info(Object object, Throwable... throwables) {
        log(object, INFO, 3, Thread.currentThread(), LocalTime.now(), throwables);
    }

    default void warn(Object object, Throwable... throwables) {
        log(object, WARN, 3, Thread.currentThread(), LocalTime.now(), throwables);
    }

    default void error(Object object, Throwable... throwables) {
        log(object, ERROR, 3, Thread.currentThread(), LocalTime.now(), throwables);
    }

    default void debug(Object object, Throwable... throwables) {
        log(object, DEBUG, 3, Thread.currentThread(), LocalTime.now(), throwables);
    }
